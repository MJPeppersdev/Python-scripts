...
welcomeMessage = "Welcome to Pass Generator!"
...
creatorMessage = "Created by Michael J Peppers on October 6th, 2021"
...
while exitMessage != 1:
    ...
    while passwordGeneratorUsage == 1:
        ...
        while passwordGeneratorPrompt == 1:
            ...
            getContinue = input('Do you want to use the Pass Generator again? (Y/N)')
            print('\n')
...
print('\n')
print('Thank you for using the Pass Generator. Have a nice day!')
